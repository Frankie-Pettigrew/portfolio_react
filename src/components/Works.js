  ...
  <div className="row">
    <div className="twelve columns collapsed">
      ...
      <div id="portfolio-wrapper" className="bgrid-thirds cf">
          ...
          <PortfolioItem id={2} title="Stereophyta" role="Game/Audio Design" ext_link="https://eastoned.itch.io/stereophyta" description="Farming/Music game where the seeds you plant become notes that evolve and grow over time in an ever-changing sequence based on wind conditions" image="images/portfolio/stereophyta.png" modal_image="images/portfolio/modals/m-stereophyta.png"/>
          <PortfolioItem id={3} title="Levedad" role="Audio Design" ext_link="https://solimporta.itch.io/levedad" description="Personal narrative game about long-exposure photography and the passage of time. Nominated for the IGF 2018 Best Student Game award" image="images/portfolio/levedad.png" modal_image="images/portfolio/modals/m-levedad.png"/>
          ...
          <PortfolioItem id={5} title="I Dream of @Dril" role="Game/Audio Design" ext_link="https://transkafka.itch.io/i-dream-of-dril" description="Intermediate Game Development final project. A viginette-style game about twitter clout and absurdity" image="images/portfolio/i_dream_of_dril.png" modal_image="images/portfolio/modals/m-i_dream_of_dril.png" />
